...
GPIO.setmode(GPIO.BOARD) # Setup the mode to match the mode on Broadcom pin labels
#pygame.init()
#pygame.mouse.set_visible(False) #disable mouse pointer
GPIO.setup(22, GPIO.IN, pull_up_down=GPIO.PUD_UP) # Set GPIO17  as input for Park button
